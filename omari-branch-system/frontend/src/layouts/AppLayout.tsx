...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: "/wallet/flocash-analytics",
        label: "FLOCASH Analytics",
        subtitle: "Customer overlap, payment patterns, and reseller intelligence for FLOCASH/Starlink proxy customers",
        icon: Satellite,
      },
      {
        to: "/crbuilder",
        label: "Report Builder",
        subtitle: "Filter, explore and export transaction data across all types, providers and date ranges",
        icon: PieChart,
      },
    ],
  },
