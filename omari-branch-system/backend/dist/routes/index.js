...
const flocash_analytics_routes_1 = __importDefault(require("./flocash-analytics.routes"));
const crbuilder_routes_1 = __importDefault(require("./crbuilder.routes"));
...
router.use("/flocash", flocash_analytics_routes_1.default);
router.use("/crbuilder", crbuilder_routes_1.default);
